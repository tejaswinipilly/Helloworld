...
Visit the official Java JDK 17 download page.
Download the Windows x64 version of the JDK.
Step 2: Install Java JD
Run the downloaded installer.
By default, Java will be installed in C:\Program Files\Java\jdk-17.
Step 3: Set Environment Variables
Right-click This PC > Properties > Advanced System Settings > Environment Variables.
Under System Variables, click New and create a variable with:
...
You should see output like java version "17".
